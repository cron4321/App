...
const socket = io('http://43.202.181.150:30700', {
  ...
  extraHeaders: {
    'Access-Control-Allow-Origin': 'http://43.202.181.150:30600',
  },
});
...
const ChatClient: React.FC = () => {
  ...
  useEffect(() => {
    fetch('http://43.202.181.150:30700/getClientName')
    ...
    fetch('http://43.202.181.150:30700/getInitialMessages')
      .then((response) => response.json())
      .then((data) => {
