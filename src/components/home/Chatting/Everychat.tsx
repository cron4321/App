...
const socket = io('http://43.202.181.150:3002', {
  ...
  extraHeaders: {
    'Access-Control-Allow-Origin': 'http://43.202.181.150:30595',
  },
});
...
const ChatClient: React.FC = () => {
  ...
  useEffect(() => {
    fetch('http://43.202.181.150:3002/getClientName')
    ...
    fetch('http://43.202.181.150:3002/getInitialMessages')
      .then((response) => response.json())
      .then((data) => {
