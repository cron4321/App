...
const socket = io('http://3.37.37.81:3002', {
  ...
  extraHeaders: {
    'Access-Control-Allow-Origin': 'http://3.37.37.81:3000',
  },
});
...
const ChatClient: React.FC = () => {
  ...
  useEffect(() => {
    fetch('http://3.37.37.81:3002/getClientName')
    ...
    fetch('http://3.37.37.81:3002/getInitialMessages')
      .then((response) => response.json())
      .then((data) => {
