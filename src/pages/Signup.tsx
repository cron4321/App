...
function Signup() {
  ...
  const sendVerificationCode = async () => {
    try {
      const response = await axios.post('http://3.37.37.81:3002/send-verification-email', { email: user.email });
  ...
  const checkDuplicate = async () => {
    try {
      const response = await axios.post('http://3.37.37.81:3002/check-duplicate', {
        email: user.email,
